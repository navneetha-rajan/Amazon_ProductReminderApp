...
public class DatabaseAccess {
    ...
    public void create(Document product) {
        ...
        newproduct.put("item_id",103);
        newproduct.put("item_name", product.get("item_name"));
        newproduct.put("category", product.get("category"));
        newproduct.put("expiry_date", product.get("expiry_date"));
        System.out.println(newproduct);
        dbTable.putItem(newproduct);

    }

    public void update(Document product) {
        product.put("item_id",rand_id);
        product.put("item_name", product.get("name"));
        product.put("category", product.get("category"));
        product.put("expiry_date", product.get("expiry_date"));
        dbTable.deleteItem(
                product.get("item_name").asPrimitive());   // The Partition Key
